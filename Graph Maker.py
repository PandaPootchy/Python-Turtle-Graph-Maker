...
def turtle_graph_program():
    ...
    label(text="Enter how many coloms: ").grid(column=0, row=2, sticky=W)
    e3.grid(column=1, row=2)
    label(text="Enter how many rows: ").grid(column=0, row=3, sticky=W)
    e4.grid(column=1, row=3)
    label(text="Want the graph to be in the center: ").grid(column=0, row=4, sticky=W)
    r1.grid(column=1, row=4)
    r2.grid(column=2, row=4)
    label(text="How fast you want the turtle to draw: ").grid(column=0,row=5, sticky=W)
    r3.grid(column=1, row=5)
    r4.grid(column=2, row=5)
    label(text="").grid()
    label(text="Click draw when your ready.").grid(column=0, row=7, sticky=W)
    b1.grid(column=1, row=7)
    b2.grid(column=2, row=7)
    label(text="").grid(column=1, row=8)
    progress.grid(column=1, row=9)
    label(text="Drawing Progress:").grid(column=0, row=9, sticky=W)
